...
SAVE_NOTE_TOOL = _tool(
    "save_note", 
    "Save a temporary note for this run.", 
    {
        "note": types.Schema(
            type="STRING", 
...
RETRIEVE_NOTES_TOOL = _tool(
    "retrieve_notes", 
    "Retrieve temporary notes.")

SAVE_MEMORY_TOOL = _tool(
    "save_memory", 
...
RETRIEVE_MEMORY_TOOL = _tool(
    "retrieve_memories", 
    "Retrieve all stored long-term memories."
    )

VECTOR_MEMORY_TOOL = _tool(
    "retrieve_memories_vector", 
    "Retrieve memories using manual vector similarity.", 
    {"query": types.Schema(
        type="STRING", 
...
CHROMA_MEMORY_TOOL = _tool(
    "retrieve_memories_chroma", 
    "Retrieve memories using Chroma.", 
    {
        "query": types.Schema(
            type="STRING", 
            description="Memory search query."), 
